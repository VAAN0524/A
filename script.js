...
function getSpiritualGuidance(card, position) {
    ...
    return guidance[card.name] || '这张牌正在为你的灵魂点亮一盏特殊的明灯，跟随它的光芒，你将发现意想不到的风景。';
}
...
function getPracticalAdvice(card, position) {
    ...
    return advice[card.name] || '这张牌的智慧正在与你的灵魂对话，用心聆听它的指引，答案将在最适合的时刻清晰显现。';
}
...
function generateLayeredMeaning(card, positionKey) {
    ...
    const personalizedMeanings = {
        '愚人': {
            upright: '你的内心正在呼唤一场全新的冒险，是时候放下对未知的恐惧，用孩童般的好奇心去探索生命的无限可能。',
            reversed: '内在的勇气正在觉醒，虽然表面看似停滞，但实际上是在为下一次伟大的腾飞积蓄能量。'
        },
        '魔术师': {
            upright: '宇宙为你准备了实现梦想的所有工具，现在需要的是相信自己的创造能力，将意念转化为有形的现实。',
            reversed: '你的创造力正在经历一次重要的转化期，旧的模式正在瓦解，为更真实的表达让路。'
        },
        '女祭司': {
            upright: '你的直觉正在被唤醒，内心的智慧之海正在涨潮，信任那些无声的指引，它们比任何逻辑都更接近真理。',
            reversed: '潜意识的大门正在打开，虽然暂时感到迷茫，但这正是通往更深层次智慧的必经之路。'
        },
        '皇后': {
            upright: '丰盛的能量正在流向你的生活，是时候接受生活慷慨的馈赠，并成为他人温暖的滋养。',
            reversed: '创造力正在经历一次重要的蜕变，旧的创造模式正在瓦解，为更真实、更有力量的表达腾出空间。'
        },
        '皇帝': {
            upright: '你内在的王者正在苏醒，是时候建立属于自己的王国，用智慧和勇气去塑造你的现实。',
            reversed: '旧的权威结构正在瓦解，但这不是失败，而是为更真实、更有智慧的你让路。'
        },
        '教皇': {
            upright: '传统智慧正在指引你的道路，在古老的知识中，你将找到解决现代问题的答案。',
            reversed: '你正在打破旧有的限制性信念，这不是对传统的背叛，而是为更高的智慧让路。'
        },
        '恋人': {
            upright: '你的心正在经历一次深刻的选择，这个选择将决定你未来爱的方向，跟随内心的声音。',
            reversed: '你正在学习爱的真谛，这不仅仅是关于爱情，更是关于如何完整地爱自己。'
        },
        '战车': {
            upright: '胜利正在向你招手，但需要的是内在的统一和明确的方向，让内心的力量协同作战。',
            reversed: '你正在经历一次重要的内在整合，看似的冲突实际上是在帮助你找到真正的平衡。'
        },
        '力量': {
            upright: '你内在的力量正在觉醒，这种力量不是来自于控制，而是来自于爱与勇气的完美结合。',
            reversed: '你正在学习真正的力量是什么，它不是外在的强硬，而是内在的温柔和坚韧。'
        },
        '隐士': {
            upright: '独处的时光正在为你带来深刻的启示，在静默中，你将听到灵魂最真实的声音。',
            reversed: '你正在从外部的喧嚣转向内心的宁静，这是一次重要的精神觉醒之旅。'
        },
        '命运之轮': {
            upright: '命运的轮盘正在转动，现在是把握机遇的关键时刻，你过去的努力将在此刻开花结果。',
            reversed: '你正在经历一个重要的周期转换，虽然暂时感到停滞，但实际上是在为下一个更大的飞跃做准备。'
        },
        '正义': {
            upright: '宇宙的平衡法则正在运作，你将为自己或他人带来公正和和谐。',
            reversed: '你正在学习什么是真正的正义，它不是简单的对错，而是更高层次的慈悲和理解。'
        },
        '倒吊人': {
            upright: '你正在经历一次重要的视角转换，放下旧有的看法，你将看到全新的世界。',
            reversed: '你正在打破旧有的限制，虽然这个过程可能充满挑战，但将带来彻底的解放。'
        },
        '死神': {
            upright: '一个重要的周期正在结束，这不是终结，而是为更美好的开始清理道路。',
            reversed: '你正在抗拒一个必要的改变，但请记住，有时候最大的恐惧背后隐藏着最大的礼物。'
        },
        '节制': {
            upright: '你内在的平衡大师正在苏醒，学会融合看似对立的力量，创造出和谐的整体。',
            reversed: '你正在学习真正的平衡，它不是静止的，而是在动态的流动中找到和谐。'
        },
        '恶魔': {
            upright: '你正在面对自己的阴影面，这不是邪恶，而是被压抑的力量和未实现的潜能。',
            reversed: '你正在挣脱束缚的锁链，这些束缚曾经看似保护，实际上却在限制你的成长。'
        },
        '塔': {
            upright: '一座虚假的大厦正在倒塌，虽然痛苦，但这将为你建立更真实的现实基础。',
            reversed: '你正在避免一场必要的崩溃，但请记住，有时候彻底的重建比修补更有效。'
        },
        '星星': {
            upright: '希望的星光正在照亮你的道路，在黑暗中，你将找到指引方向的光芒。',
            reversed: '你正在学习如何在现实世界中保持内心的星光，即使在最黑暗的时刻，也要相信光的存在。'
        },
        '月亮': {
            upright: '你正在深入潜意识的海洋，虽然神秘莫测，但隐藏着最珍贵的珍珠。',
            reversed: '你正在克服内心的恐惧和幻象，当迷雾散去，你将看到真实的美。'
        },
        '太阳': {
            upright: '成功和喜悦正在你的前方闪耀，你的内在光芒即将照亮整个世界。',
            reversed: '你正在学习如何在平凡中发现神圣，即使在最阴郁的日子里，也要相信太阳的存在。'
        },
        '审判': {
            upright: '你正在经历一次重要的觉醒，过去的经历正在转化为未来的智慧。',
            reversed: '你正在学会宽恕自己，这是通往真正自由和重生的关键。'
        },
        '世界': {
            upright: '你已经完成了一个重要的周期，现在是收获成果，并准备开始更伟大的旅程。',
            reversed: '你正在学习什么是真正的完成，它不是终点，而是无限可能性的开始。'
        }
    };
...
function getContextualAdvice(cardAnalysis) {
    ...
    const defaultAdvice = {
        primary: '🌟 **与生命共舞**：每一张牌都是宇宙给你的独特情书，仔细阅读其中的深意。',
        secondary: '你的直觉是最可靠的指南针，即使在迷雾中也能找到正确的方向。',
        spiritual: '你的灵魂正在经历一次美丽的觉醒，每一个挑战都是通往更高境界的阶梯。'
    };
...
function getActionableSteps(cardAnalysis) {
    ...
    const themeSteps = {
        '新的开始与探索': [
            '🔄 内在探索：深入挖掘被忽略的内在宝藏，释放隐藏的潜能',
            '🧘 静心修行：通过内观和冥想，重新连接灵魂深处的宁静',
            '📝 写下你的愿望和目标',
            '🎨 尝试新的爱好或活动'
        ],
        '主动创造与显化': [
            ...
            '🎯 愿景构建：清晰描绘你渴望实现的未来蓝图',
            '💭 创作愿景板：收集图片、文字和符号，代表你的理想未来',
            '⚡ 每天进行显化练习：花10分钟感受已经实现目标的情感'
        ],
        '直觉与内在智慧': [
            '📖 开始写梦境日记：记录梦境中的象征和情感',
            '🌙 进行新月仪式：在新月时设定意图，释放不再需要的东西'
        ],
        '关系与和谐': [
            '💬 主动沟通：向重要的人表达真实的感受和需求',
            '🌻 建立边界：学会说"不"，保护自己的能量'
        ],
        '事业与成就': [
            '🚀 制定3个月计划：将大目标分解为可执行的小步骤',
            '🎯 技能提升：每月学习一项新技能或工具'
        ],
        '财富与丰盛': [
            '💰 制定预算计划：清楚地了解收入和支出流向',
...
function getTimeframeAdvice(cardAnalysis) {
    if (cardAnalysis.positionBalance.upright >= 2) {
        ...
        return {
            energy: '深度蜕变期',
            timeframe: '中期间奏（1-3个月）',
            advice: '你的内在正在进行一场重要的重构，像蝴蝶破茧而出需要时间和耐心'
        };
    } else {
        return {
            energy: '和谐流动期',
            timeframe: '循序渐进的成长',
            advice: '生命之河正在平稳流淌，每一个微小的选择都在塑造你的未来'
        };
    }
}
...
// 页面加载完成后初始化 - 移除了updateDynamicTexts调用，现在由language.js处理
// document.addEventListener('DOMContentLoaded', function() {
//     // 初始化语言设置（由translations.js处理）
//     // 更新所有动态文本
